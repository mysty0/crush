    ...
    try {
      const initResult = await initializeConnection(transport, {
        ...
        async onInitialized() {
          ...
          if (
            'startSSEListener' in transport! &&
            typeof transport!.startSSEListener === 'function'
          ) {
...
export async function listTools(
  ...
  do {
    ...
    const result = await connection.transport.request<MCPToolsListResult>(
      'tools/list',
      params,
      options,
    );
...
export async function listResources(
  ...
  do {
    ...
    const result = await connection.transport.request<MCPResourcesListResult>(
      'resources/list',
      params,
      options,
    );
...
export async function listPrompts(
  ...
  do {
    ...
    const result = await connection.transport.request<MCPPromptsListResult>(
      'prompts/list',
      params,
      options,
    );
