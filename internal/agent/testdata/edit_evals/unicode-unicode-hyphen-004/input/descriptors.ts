...
export function allowsUnauthenticatedCatalogDiscovery(
...
export const PROVIDER_DESCRIPTORS: readonly ProviderDescriptor[] = [
  ...
  descriptor('opencode-zen', 'claude-sonnet-4-6', (config) =>
  ...
  catalogDescriptor(
    ...
    catalog('Qwen Portal', ['QWEN_OAUTH_TOKEN', 'QWEN_PORTAL_API_KEY'], {
  ...
  descriptor('lm-studio', 'llama-3-8b', (config) => lmStudioModelManagerOptions(config), {
    allowUnauthenticated: true,
  }),
  catalogDescriptor(
    'vllm',
