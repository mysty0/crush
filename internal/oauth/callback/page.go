...
// PageResult is the data the browser landing page is rendered from.
// Distinct from Result, which carries the redirect's query parameters.
...
func (r PageResult) Failed() bool { return r.ErrorCode != "" }
...
// a blank tab.
func Write(w io.Writer, r PageResult) error {
...
func Serve(w http.ResponseWriter, r PageResult) error {
